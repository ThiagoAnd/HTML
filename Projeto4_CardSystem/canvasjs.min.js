...
(k._creditLink=document.createElement("a"),k._creditLink.setAttribute("title","JavaScript Chartsss"),k._creditLink.setAttribute("style","outline:none;margin:0px;position:relative;visibility: hidden;right:2px;top:"+(k.height-14)+"px;color:dimgrey;text-decoration:none;font-size:11px;font-family: Calibri, Lucida Grande, Lucida Sans Unicode, Arial, sans-serif"),k._creditLink.setAttribute("tabIndex",-1),k._creditLink.setAttribute("target","_blank"));if(0===k.renderCount||
